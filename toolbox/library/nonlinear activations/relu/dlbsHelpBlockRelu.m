function page = dlbsHelpBlockRelu()

page = dlbsHelpPageTemplate("dlbsHelpBlockRelu", "ReLU");
page.setBlockLibraryPath("dlbsBlockRelu/Relu")

page.addTitle("ReLU");
page.addBlockImage("block")
page.addParagraphAndMaskHelp("Applies the rectified linear unit activation to the input tensor. The operation is applied element-wise across all tensor elements.");
