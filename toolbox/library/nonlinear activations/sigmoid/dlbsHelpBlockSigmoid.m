function page = dlbsHelpBlockSigmoid()

page = dlbsHelpPageTemplate("dlbsHelpBlockSigmoid", "Sigmoid");

page.addTitle("Sigmoid");
page.setBlockLibraryPath("dlbsBlockSigmoid/Sigmoid")
page.addBlockImage("block")
page.addParagraphAndMaskHelp("Applies the logistic sigmoid activation to the input tensor. The operation is applied element-wise across all tensor elements.");
...
page.addParagraph("$$Y = \frac{1}{1 + e^{-X}}$$")
