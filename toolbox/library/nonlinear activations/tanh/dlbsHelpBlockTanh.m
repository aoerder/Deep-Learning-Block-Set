function page = dlbsHelpBlockTanh()

page = dlbsHelpPageTemplate("dlbsHelpBlockTanh", "Tanh");

page.addTitle("Tanh");
page.setBlockLibraryPath("dlbsBlockTanh/Tanh")
page.addBlockImage("block")
page.addParagraphAndMaskHelp("Applies the hyperbolic tangent activation to the input tensor. The operation is applied element-wise across all tensor elements.");
