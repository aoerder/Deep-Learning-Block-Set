function page = dlbsHelpBlockCos()

page = dlbsHelpPageTemplate("dlbsHelpBlockCos", "cos");

page.addTitle("Cos");
page.setBlockLibraryPath("dlbsBlockCos/cos")
page.addBlockImage("block")
page.addParagraphAndMaskHelp("Applies the cosine function to the input tensor. The operation is applied element-wise across all tensor elements.");
