function page = dlbsHelpBlockLog()

page = dlbsHelpPageTemplate("dlbsHelpBlockLog", "Log");

page.addTitle("Log");
page.setBlockLibraryPath("dlbsBlockLog/Log")
page.addBlockImage("block")
page.addParagraphAndMaskHelp("Applies the natural logarithm to the input tensor. The operation is applied element-wise across all tensor elements.");
...
io(1).Size = "(d1,d2,...,dn)";
io(1).Description = "Input tensor. Values must be positive.";
io(2).Port = "Y";
