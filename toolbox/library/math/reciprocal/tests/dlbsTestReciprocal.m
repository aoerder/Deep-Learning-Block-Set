classdef dlbsTestReciprocal < dlbsAbstractHarnessTest
    ...
    methods (Test)
        ...
        function testCalc(testCase)
            ...
            % Setup nonzero inputs for element-wise reciprocal
            inputs.X = randn(3,3);
            inputs.X(abs(inputs.X) < 0.1) = 0.1;
            inputs.dY = randn(3,3);

            % Simulate the model
            testCase.setHarness("dlbsTestHarnessReciprocal");
